      ...
      <View style={{flexDirection:"column", width:"100%"}}>
        ...
        <View style={{width: "100%", flexDirection: 'column',  marginBottom:10, marginTop:5, fontSize:15, justifyContent:"flex-start"}}>
          {this.props.changePossible ?
            <TextInput type="text" style={{ height:30*this.props.heightSize, textAlign:"left", display: 'flex', flexDirection: 'column', justifyContent:"center", borderRadius:3,  color:"rgba(50,50,50,1)", borderWidth:1, borderStyle:"solid", borderColor:"rgba(100,100,100,1)",width:"100%", backgroundColor:"rgba(245,245,245,1)", paddingLeft:10}} value={this.state.value} onChange={(e) => this.onChange(e)}/>
            :
